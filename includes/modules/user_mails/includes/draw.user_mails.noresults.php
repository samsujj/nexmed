	...
	<fieldset class="te">
		...
		<div class="te_noresults">
			...
			<div>
					...
					<!--<a class="te_button te_new_button" href="<?php //echo $this->url( 'te_mode=insert' ); ?>" title="New"><span class="te_button te_new_button">New</span></a>-->

			</div>
			<p class="to_noresults">No Result Found.</p>
